	  ...
	  protected SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
	    http.cors(Customizer.withDefaults())
	        ...
	        .authorizeHttpRequests(r -> r
	        		.requestMatchers(HttpMethod.GET, "/dependencia/listado").permitAll()
	        		.requestMatchers(HttpMethod.GET, "/tipoReclamo/listado").permitAll()
	        		.requestMatchers(HttpMethod.POST, "/sugerencia/nuevo").permitAll()
